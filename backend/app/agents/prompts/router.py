...
1. "rag": The user is asking a question about specific documents, OR providing a topic/title that could be in the documents (e.g. "python", "analytics", "IPython").
   - Keywords: "summarize", "document", "what does the text say", "pdf", and ANY technical term or topic.
...
3. "general_chat": STRICTLY for greetings (hello, hi), personal questions (who are you), or creative tasks (write a poem). 
   - DO NOT use this for factual queries. If the user asks "what is X?", assume it might be in the documents and use "rag".
